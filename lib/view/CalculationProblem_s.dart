          ...
          children: <Widget>[
            ...
            Stack(
              children: [
                ...
                Container(
                  ...
                  child: (() {
                    if (calculation == 0) {
                      return Text('$rand1+$rand2=',
                          style: const TextStyle(fontSize: 40));
                    } else if (calculation == 1) {
                      return Text('$rand1-$rand2=',
                          style: const TextStyle(fontSize: 40));
                    } else if (calculation == 2) {
                      return Text('$rand3×$rand4=',
                          style: const TextStyle(fontSize: 40));
                    } else {
                      return Text('$product÷$rand3=',
                          style: const TextStyle(fontSize: 40));
                    }
                  })(),
                ),
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                  border: OutlineInputBorder(), labelText: '解答を入力'),
